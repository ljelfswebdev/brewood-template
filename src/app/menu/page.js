    ...
    const handlePrintImage = () => {
      ...
      const addItem = (e) => {
        ...
        if (item.trim() !== "" && cost.trim() !== "") {
          setMenuItems([...menuItems, { item, cost }]);
          setItem("");
          setCost("");
        }
      };
        ...
        <div className="content">
          <div className="form">
            ...
            <div className="form__menu">
                <span className="form__title">Add Item</span>
                <input
                  type="text"
                  id="item"
                ...
                />
                <button className="form__print" onClick={addItem}>
                  Add Item
                </button>
            ...
            {menuItems.map((menuItem, index) => (
                <li key={index}>
                    <span id="menu-item-item">{menuItem.item}</span>
                    <button className="" onClick={() => deleteItem(index)}>Delete</button>
                </li>
                ))}
          ...
          <div className="template">
            ...
            <div className="template__content">
              ...
              <div className="template__result">Menu</div>
                ...
                <div className="menu-items">
                    <ul>
                        ...
                        <li key={index}>
                            <span id="menu-item-item">{menuItem.item}</span>
                            <span id="menu-item-cost">{menuItem.cost}</span>
                        </li>
                        ))}
                    </ul>
                </div>
                <div className="menu-allegry">
                Please note that if you have any allergies, we cannot guarantee our food is allergy free but we are happy to discuss on an individual basis
                </div>
