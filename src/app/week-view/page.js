...
//         />
//         <button onClick={() => handleAddInput(day)}>Add</button>
//         {inputValues[day] && (
//           <button onClick={() => handleDeleteInput(day)}>Delete</button>
//         )}
//       </div>
//     ));
//   };
          ...
          <div className="template">
            ...
            <div className="template__content">
              ...
              <div className="template__week-dates">
                <span>{selectedWeekStart} - {selectedWeekEnd}</span> 
              </div>
              <div className="template__week">
                {renderDayDivs()}
              </div>
